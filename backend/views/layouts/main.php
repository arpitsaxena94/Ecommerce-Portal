...
<div id="wrapper">
    ...
    <ul class="navbar-nav custom-sidebar sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
            ...
            <!--            </div>-->
            <img src="<?= \Yii::getAlias('@web') ?>/img/duicon.png" alt="Icon" width="80px;">

            <div class="sidebar-brand-text mx-3">Samarth Admin</div>
        </a>
            ...
            <div class="container my-auto">
                <div class="row copyright">
                    ...
                    <div class="col text-right">
                        Created by <a href="" target="_blank">arpitsaxena</a>
                    </div>
                </div>
            </div>
        </footer>
